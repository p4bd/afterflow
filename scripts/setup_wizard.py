#!/usr/bin/env python3
"""AfterFlow interactive setup wizard.
...
def main() -> int:
    try:
        ...
        print()
        print(bold("Welcome to AfterFlow Setup!"))
        print("This wizard will help you configure AfterFlow in a few minutes.")
        print()
        ...
        print(f"  {cyan('make dev')}        # Start AfterFlow")
        print()
