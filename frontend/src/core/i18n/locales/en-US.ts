...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Turn order, payment, logistics, and policy evidence into reviewable, executable, and auditable after-sales decisions.",

    createYourOwnSkill: "Configure after-sales capabilities",
    createYourOwnSkillDescription:
      "Use domain skills to enforce evidence collection, policy constraints, and customer communication standards.",
  },
  ...
  // Sidebar
  sidebar: {
    newChat: "Start after-sales case",
    chats: "After-sales assistant",
    channels: "Channels",
    recentChats: "Recent cases",
    demoChats: "Demo chats",
    agents: "Agents",
    afterSales: "After-sales",
    scheduledTasks: "Operations review",
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. AfterFlow is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but AfterFlow could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "AfterFlow project home",
    githubTooltip: "AfterFlow on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "AfterFlow on GitHub",
    reportIssue: "Report an issue",
    contactUs: "Contact us",
    about: "About AfterFlow",
    logout: "Log out",
  ...
  channels: {
    ...
    descriptions: {
      telegram: "Telegram direct messages through your AfterFlow bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your AfterFlow bot.",
      feishu: "Feishu and Lark messages through your AfterFlow app.",
      dingtalk: "DingTalk Stream Push messages through your AfterFlow bot.",
      wechat: "WeChat iLink messages through your AfterFlow bot.",
      wecom: "WeCom messages through your AfterFlow AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to AfterFlow",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate AfterFlow faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how AfterFlow looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "AfterFlow extracts reusable context from case handling records to keep future decisions consistent.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to AfterFlow from outside the browser.",
      disabled:
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under `/skills/custom` in the project root.",
    ...
    notification: {
      title: "Notification",
      description:
        "AfterFlow only sends a completion notification when the window is not active, which is useful while long-running cases are processing.",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so AfterFlow cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "AfterFlow needs an administrator account before new regular accounts can be created.",
