...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "从订单、支付、物流和政策证据出发，生成可审批、可执行、可追溯的售后方案。",

    createYourOwnSkill: "配置售后处理能力",
    createYourOwnSkillDescription:
      "用领域 Skill 固化取证顺序、政策约束和客户沟通要求。",
  },
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，AfterFlow 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 AfterFlow 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 AfterFlow 项目主页",
    githubTooltip: "访问 AfterFlow 项目仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 GitHub 上查看 AfterFlow",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 AfterFlow",
    logout: "退出登录",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      telegram: "通过 AfterFlow Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 AfterFlow Bot 接收 Discord 服务器消息。",
      feishu: "通过 AfterFlow 应用接收飞书和 Lark 消息。",
      dingtalk: "通过 AfterFlow Bot 接收钉钉 Stream Push 消息。",
      wechat: "通过 AfterFlow Bot 接收微信 iLink 消息。",
      wecom: "通过 AfterFlow AI Bot 接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 AfterFlow 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 AfterFlow。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 AfterFlow 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      channels: "渠道",
    ...
    memory: {
      title: "记忆",
      description:
        "AfterFlow 会在后台从售后处理记录中提取可复用上下文，帮助后续案件保持一致。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    channels: {
      title: "渠道",
      description: "连接可在浏览器外向 AfterFlow 发送消息的即时通讯账号。",
      disabled:
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在项目根目录的 `/skills/custom` 文件夹中。",
    ...
    notification: {
      title: "通知",
      description:
        "AfterFlow 只会在窗口不活跃时发送完成通知，适合等待长时间案件处理时使用。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，AfterFlow 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "AfterFlow 需要先创建管理员账号，然后才能创建新的普通账号。",
